...
#'
#' `py_table_annual_exposure` reads in a data.frame/tibble containing basic demographic information
...
py_table_annual_exposure <- function(person_data, exposure_data,
